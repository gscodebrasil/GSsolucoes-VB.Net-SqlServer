...
#Region "Anexo de cliente - Phonebook"
    ...
    Public Function FormataGridViewCliente_Phonebook(ColumnChkBox As Boolean, ColumnName As String, ColumnData As String, ColumnTamanho As String, Dgv As Guna2DataGridView)
        With Dgv
    ...
    Public Function FileListCliente_Phonebook(Dgv As Guna2DataGridView, Cliente As String)
        Try
            Using Sftp As SftpClient = Getconnection()
                Sftp.Connect()
    ...
    Public Function CarregarArquivo_Phonebook(Dgv As Guna2DataGridView, Ofd As OpenFileDialog, Cliente As String)
        Ofd.Title = "Selecione Arquivo"
